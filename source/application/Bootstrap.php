...
class Bootstrap extends Zend_Application_Bootstrap_BootstrapAbstract {
    ...
    protected function _initDefaultModuleAutoloader() {
        ...
        $this->_resourceLoader->addResourceTypes ( array ('siteControllerHelper' => array ('path' => 'modules/site/controllers/helpers', 'namespace' => 'Site_Controller_Helper' ), 'siteViewHelper' => array ('path' => 'modules/site/views/helpers', 'namespace' => 'Site_View_Helper' ), 'adminViewHelper' => array ('path' => 'modules/admin/views/helpers', 'namespace' => 'Admin_View_Helper' ), 'adminControllerHelper' => array ('path' => 'modules/admin/controllers/helpers', 'namespace' => 'Admin_Controller_Helper' ), 'adminbkControllerHelper' => array ('path' => 'modules/adminbk/controllers/helpers', 'namespace' => 'Adminbk_Controller_Helper' ) ) );
        $resourceLoader = new Zend_Loader_Autoloader_Resource ( array ('basePath' => APPLICATION_PATH, 'namespace' => '', 'resourceTypes' => array ('model' => array ('path' => 'models', 'namespace' => 'Model' ) ) ) );
