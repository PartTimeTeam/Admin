head.ready(function () {
	...
	Singleton(siteConfig.namespace + '.Order', {
	    ...
	    __init__: function() {
	        ...
	        var columnDefs = [
                          ...
                          },
                          {
                          ...
                          },
	  					 {
	  							"render": function ( data, type, row ) {
	  								var action = '';
	  								action += '<button type="button" onclick="window.location =\'/order-detail/detail/id/'+row['order_id']+'\'" class="btn btn-primary" rel="tooltip" data-placement="top" title="Detail"><i class="fa fa-pencil-square-o"></i></button> &nbsp;';
	  								return action;
	  							},
	  							"targets": 10,
	  							"orderable": false,
	        ...
	        XRace.ui.Widget.setupDataTable( "#orderTable", "/order-detail/list", aoColumns, columnDefs, {order:[[ 0, "desc" ]]});
	    },
	    /*
         * delete
         */
