<?php
	$openinviter_settings=array(
		"username"=>"MinhVN",
		"private_key"=>"88a988f00129fa4304fe7189dee7ce11",
		"cookie_path"=> BASE_PATH . '/data/caches',
		"message_body"=>"You are invited to http://minhvn.net", // http://minhvn.net is the website on your account. If wrong, please update your account at OpenInviter.com
		"message_subject"=>" is inviting you to http://minhvn.net", // http://minhvn.net is the website on your account. If wrong, please update your account at OpenInviter.com
